...
## primPlaneBuilder
#
# builder for primPlane
class primPlaneBuilder(gegede.builder.Builder):
    ...
    def construct( self, geom ):
        primPlaneBox = geom.shapes.Box( self.name, dx=self.primDimension[0], dy=self.primDimension[1], dz=self.primDimension[2] )
        main_lv = geom.structure.Volume( self.name+"_lv", material=self.primMaterial, shape=primPlaneBox )
