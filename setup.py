...
setup(name = 'dunendggd',
      ...
      author_email = 'gyang@nngroup.physics.sunysb.edu, jose.palominogallo@stonybrook.edu',
      license = 'GPLv2',
      url = 'https://github.com/gyang9/GuJo',
      package_dir = {},
      packages = ['duneggd', 'duneggd.Det', 'duneggd.Module', 'duneggd.Component', 'duneggd.Active'],
      install_requires = [
        "gegede >= 0.4",
