...
class rmmsBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):        
        ...
        thin_layer_lv = geom.structure.Volume( 'thinlayervol', material='NoGas', shape=thin_layer )
        thick_layer_lv = geom.structure.Volume( 'thicklayervol', material='NoGas', shape=thick_layer )
        ...
        ModuleBox = geom.shapes.Box( 'ModuleBox',
                                     ...
                                     dy = 0.5*Q("3.2m"),
                                     dz = 0.5*Q("0.01m"))
        ModuleBox_lv = geom.structure.Volume( 'ModuleBoxvol', material='NoGas', shape=ModuleBox )
        ...
        Module_layer_lv = geom.structure.Volume( 'modulelayervol', material='NoGas', shape=Module_layer )

         #Poition modules in layer volumes                                                                                                                         

        mod_pos1 = geom.structure.Position( 'modpos1'+self.name,
                                          -0.5*Q("7.04m")+0.5*Q("0.04m")*42+Q("0.035m"),
                                          Q("0m"),
                                          Q("0m"))
