...
import ndcore.localtools as localtools
...
class SingleArrangePlaneBuilder(gegede.builder.Builder):
    ...
    def construct( self, geom ):
        ...
        '''
        shapename = type(el_shape).__name__
        if "Box" in shapename:
            el_dim = [el_shape.dx, el_shape.dy, el_shape.dz]
        elif "Tubs" in shapename:
            el_dim = [el_shape.rmax, el_shape.rmax, el_shape.dz]
        elif "Sphere" in shapename:
            el_dim = [el_shape.rmax, el_shape.rmax, el_shape.rmax]
        '''
